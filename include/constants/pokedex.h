...
enum ObtainableDexOrder {
    ...
    OBTAINABLE_DEX_ROTOM,
    OBTAINABLE_DEX_UXIE,
    OBTAINABLE_DEX_MESPRIT,
    OBTAINABLE_DEX_AZELF,
    OBTAINABLE_DEX_DIALGA,
    OBTAINABLE_DEX_PALKIA,
    OBTAINABLE_DEX_HEATRAN,
    OBTAINABLE_DEX_GIRATINA,
    OBTAINABLE_DEX_CRESSELIA,
    OBTAINABLE_DEX_PHIONE,
    OBTAINABLE_DEX_MANAPHY,
    OBTAINABLE_DEX_DARKRAI,
    OBTAINABLE_DEX_SHAYMIN,
